...
-> Comandos para crear las migraciones sin necesidad de crear un entorno virtual: - Tienes que estar ubicado en el directorio /backend para que estos funcionen. - Si ya has ejecutado el comoando "db init" este ya no es necesario volver a ejecutarlo
