"""Migracion base limpia

Revision ID: 31760c8aae0b
Revises: 80b3032ca459
Create Date: 2026-04-12 13:33:07.495177
...
revision = '31760c8aae0b'
down_revision = '80b3032ca459'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('cancelaciones', schema=None) as batch_op:
        batch_op.alter_column('motivo_cancelacion_cond',
               existing_type=sa.VARCHAR(length=50),
               nullable=False)
        batch_op.alter_column('motivo_cancelacion_pasaj',
               existing_type=sa.VARCHAR(length=50),
               nullable=False)
