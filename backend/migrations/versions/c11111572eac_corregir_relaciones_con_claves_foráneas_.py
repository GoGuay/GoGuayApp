...
Revision ID: c11111572eac
Revises: 
Create Date: 2025-06-10 21:57:11.061295
...
def upgrade():
    ...
    sa.Column('emailVerificado', sa.Boolean(), nullable=True),
    ...
    sa.Column('telefonoVerificado', sa.Boolean(), nullable=True),
    sa.Column('biografia', sa.String(length=500), nullable=True),
    sa.Column('fotoPerfil', sa.String(length=250), nullable=True),
    sa.Column('fotoCabecera', sa.String(length=250), nullable=True),
