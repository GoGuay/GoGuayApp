...
def create_app():
    ...
    CORS(app, resources={r"/*": {"origins": ["http://localhost:4200", "https://pride-ride.vercel.app", "https://pride-ride-4tpkx55u8-priderides-projects.vercel.app"], "supports_credentials": True}})
